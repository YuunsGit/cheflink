            ...
            <div className="col-span-full w-full">
              ...
              <div className="mt-2 flex items-center gap-x-2 rounded-md pl-2 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-secondary-500">
                ...
                <textarea
                  ...
                  className="block w-full resize-y whitespace-pre break-words border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-0 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
          </div>
